...
function modifyViewerOptions(options) {
  ...
  if (fs.existsSync(path.join(__dirname, '../node_modules'))) {
    options.resolveLoaderRoots.push(

        // Allow loader modules to be resolved from node_modules directory of
        // this project in addition to the node_modules directory of
        // neuroglancer.
